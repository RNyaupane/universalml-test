  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-1 gap-10 md:col-span-2 w-full">
        <div className="big-container rounded-3xl shadow-xs pt-6 md:pt-9 px-3 md:px-5 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-15 " style={{ marginTop: "20px" }}>
            ...
            {/* Second Row */}
            <div className="md:col-span-1 h-16" style={{ ...buttonStyle, height: '250px', borderRadius: '10px', marginTop: "20px" }}>
              ...
              <p className='text-gray-700 text-sm' style={{ padding: "0 20px 0 20px", fontSize: "14px" }}>
            ...
            <div className="md:col-span-2 h-16" style={{ ...buttonStyle, height: '250px', borderRadius: '10px', marginTop: "20px" }}>
