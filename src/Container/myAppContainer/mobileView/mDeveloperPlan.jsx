            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-10 md:col-span-2  w-full ">
                <div className="big-container rounded-3xl h-full pt-9 px-3 ">
                    <div className='flex items-center text-theme px-7'>
                        ...
                        <h1 className='text-xl md:text-3xl font-semibold m-2'>Developer</h1>
                    </div>

                    <div className="flex flex-col lg:flex-row p-0 md:p-5">
                        {/* Left Column */}
                        <div className="lg:w-2/5">
                            {/* Small Card 1 */}
                            <div className="card-light p-4 mx-2 mb-5 mt-2 rounded-3xl">
                                <h2 className="font-bold text-2xl md:text-4xl">Developer Plan</h2>
                                <div className="flex mt-12 items-end">
                                    <h3 className='text-xl xl:text-3xl font-semibold mb-0'>$128 Used</h3>
                                </div>
                                ...
                                <div className="flex justify-between ms-auto p-2">
                                    <p className='font-semibold text-secondary text-xs'>September</p>
                                    <p className='font-semibold text-secondary text-xs'>October</p>
                                </div>
                            </div>
                            ...
                            <div className="p-4 m-2 rounded-3xl card-light">
                                ...
                                <button className="btn-theme text-white font-bold text-base py-3 mt-6 w-full px-10 rounded-xl ">
                                    Generate secret key
                                </button>
                            </div>
                        </div>
                       ...
                       <div className="lg:w-3/5">
                            ...
                            <div className="p-4 m-2 rounded-3xl card-light h-[483px] flex flex-col justify-center items-center">
                                <h2 className="font-bold text-2xl md:text-4xl">Total Expenses</h2>
