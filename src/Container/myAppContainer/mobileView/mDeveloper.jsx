    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-10 md:col-span-2  w-full ">
        <div className="big-container rounded-3xl h-full pt-9 px-3 ">
          <div className='flex items-center text-theme px-3'>
            <Link to='/my-app'>
              <IoIosArrowBack className='text-3xl md:text-3xl me-3' />
            </Link>
            <FiTool className='text-2xl md:text-3xl ' />
            <h1 className='text-xl font-semibold m-2'>Developer</h1>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-1 xl:grid-cols-4 gap-6 mx-1 md:mx-6 my-6 rounded-3xl">
            ...
            <div className="col-span-1 md:col-span-2 xl:col-span-2 card-light py-6 px-6 rounded-3xl">
              <h2 className="font-bold text-2xl md:text-4xl">Your Current Plan</h2>
              <div className="flex mt-12 items-end">
                <h3 className='text-xl xl:text-3xl font-semibold mb-0'>$5 credit</h3>
                <p className='text-secondary ms-4 text-sm font-bold'>Free</p>
              </div>
              ...
              <div className="flex justify-between ms-auto p-2">
                <p className='font-semibold text-secondary text-xs'>Used $3</p>
            ...
            <div className="col-span-1 md:col-span-2 xl:col-span-2 card-light p-6 rounded-3xl">
              <h2 className="font-bold text-2xl md:text-4xl">Upgrade to Pro plans</h2>
              <div className="flex mt-9 items-end">
                <Link to='/my-app/developer/plan/mobile' className='text-theme text-lg md:text-2xl font-semibold'>Developer plan
                  <i className="bi bi-chevron-right profile-link text-base" style={{ textShadow: "0 0 1px black" }}></i>
                </Link>
              </div>
              <div className="flex mt-4 items-end">
                <Link className='text-theme text-lg md:text-2xl font-semibold'>Business plan
                  <i className="bi bi-chevron-right profile-link text-base" style={{ textShadow: "0 0 1px black" }}></i>
                </Link>
              </div>
            </div>
            ...
            {/* left Column */}
            <div className="col-span-1 md:col-span-2 xl:col-span-2 card-light py-6 px-6 rounded-3xl">
              <h2 className="font-bold text-2xl md:text-4xl">API Keys</h2>
